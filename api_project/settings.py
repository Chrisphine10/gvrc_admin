...
MIDDLEWARE = [
    ...
    'core.middleware.performance_middleware.CacheMiddleware',
    'core.exceptions.handlers.APIExceptionMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'api_project'),
