...
class County(models.Model):
    ...
    bbox_north = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True)
    bbox_south = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True)
    bbox_east = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True)
    bbox_west = models.DecimalField(max_digits=10, decimal_places=7, null=True, blank=True)
